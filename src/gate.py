...
# 요지는 밀도 보강용이지 통과 사유가 아니다. PR #27 로 요지를 글감에 넣었더니
# 목표가·투자의견이 없는 IR 소개자료가 게이트를 통과해 리서치 발송을 점령했다
# (실측 #125: 발송 8건 중 7건이 한국IR협의회, fit 1점 6건).
# 투자 판단 정보가 있는 리포트만 통과시킨다 — 원래 게이트 의도다.
