...
6. fit       : 커뮤니티 적합성. **이미 그 종목을 보고 있는 사람이**
   ...
   문장이 매끄러운 것과 무관하다. 아래 기준으로 매긴다.
     1점 — 시세 수치를 옮겨 적기만 했다
     2점 — 수치는 여럿인데 서로 무관하게 나열됐다
     3점 — 수치 사이의 관계·비중·맥락을 한 번이라도 짚었다
            (예: 하루 등락이 5거래일 누적의 대부분을 만들었다,
             거래량이 평소 대비 몇 배인지, 고가 대비 어디서 마감했는지)
     4점 — 시세 화면에 없는 사실을 더했다 (수급 주체, 공시 내용, 계약 규모)
     5점 — 그 사실이 왜 이 종목에 의미 있는지까지 사실 범위에서 연결했다
