...
_CHANGE = (
    "{subject} 기준일 종가 기준으로 {pct}% {direction}했습니다.",
    "{name}의 기준일 마감 등락률은 {pct}% {direction_noun}이었습니다.",
    "{subject} 기준일 종가 기준으로 {pct}% {direction}했네요.",
    "{subject} 기준일 주식시장에서 {pct}% {direction}했습니다.",
    "{name}의 기준일 마감 주가 변동은 {pct}% {direction_noun}이었어요.",
    "{subject} 기준일 마감 기준 {pct}% {direction}했습니다.",
    "{subject} 기준일 등락률이 {pct}% {direction_noun}으로 집계됐습니다.",
    "{name}의 기준일 마감 등락률은 {pct}% {direction_noun}이었네요.",
)
...
_CLOSE = (
    ...
    "기준일 종가는 {close}원입니다.",
    "마감 종가는 {close}원이었어요.",
    "종가 수치는 {close}원으로 집계됐습니다.",
    "해당 기준일 종가는 {close}원이었네요.",
)
...
def _relation_sentence(kind: str, value: str, direction: str,
    ...
    choices = {
        "vol_ratio": (
            ...
            "거래량을 20일 평균과 비교하면 {v}배였어요.",
            "20일 평균을 기준으로 한 거래량 배수는 {v}배입니다.",
            "거래량 기준값은 20일 평균의 {v}배였네요.",
            "평균 거래량과 비교한 값은 20일 평균의 {v}배였습니다.",
            "거래량은 20일 평균을 기준으로 {v}배로 집계됐네요.",
            "20일 평균에 대한 거래량 배수는 {v}배였어요.",
        ),
        "ret5": (
            "5거래일 누적 기준으로는 {v}% {d}했습니다.",
            "5거래일 누적 등락률은 {v}% {dn}이었네요.",
            "누적 5거래일 흐름은 {v}% {dn}이었어요.",
            "5거래일 동안의 누적 등락률은 {v}% {dn}입니다.",
            "5거래일 누적 값은 {v}% {dn}이었네요.",
            "누적 등락률을 5거래일 기준으로 보면 {v}% {dn}이었습니다.",
            "5거래일 누적 수치는 {v}% {dn}으로 집계됐네요.",
            "누적 5거래일 기준 등락률은 {v}% {dn}이었어요.",
        ),
        "close_pos": (
            "종가는 장중 고가 대비 {v}% 낮은 수준이었습니다.",
            "장중 고가 대비 마감 위치는 {v}% 낮았네요.",
            "마감 가격은 장중 고가 대비 {v}% 낮은 수준이었어요.",
            "마감 위치는 장중 고가 대비 {v}% 낮았습니다.",
            "종가의 마감 위치는 장중 고가 대비 {v}% 낮았네요.",
            "장중 고가와 비교한 마감 위치는 {v}% 낮은 수준이었습니다.",
            "종가는 장중 고가 대비 {v}% 아래에서 마쳤네요.",
            "장중 고가 대비 종가의 마감 위치는 {v}% 낮았어요.",
        ),
    }
