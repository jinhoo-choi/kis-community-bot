...
VOICES = {
    ...
    "calm": {
        ...
        "desc": "종결어미는 '~습니다' 와 '~인데요' 를 섞어 씁니다.\n"
                "반드시 한 문장은 반대 방향이나 조심할 지점을 담습니다. "
                "예: 변동폭이 컸다는 사실, 되돌림이 있었다는 사실.\n"
                "다만 그 문장도 입력에 있는 사실로만 씁니다. 전망을 넣지 않습니다.",
    },
    "light": {
        "name": "가벼움",
...
- 제공된 숫자 중 **정확히 2개 또는 3개만** 사용합니다. 4개 이상 쓰면 안 됩니다.
- 어떤 숫자를 남길지는 위 [이 글이 독자에게 알려줄 하나]가 정합니다.
