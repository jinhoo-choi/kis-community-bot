...
def testmsg():
    ...
    print(
        ...
        "리포트 · 전문 · 종목방\n"
        "<i>claude · 심사 18/20</i>\n\n"
        "<pre>산일전기가 8월에만 두 건의 수주를 공시했습니다.\n"
        "증권사는 저평가 구간이라는 의견을 냈네요.\n"
        "다만 목표주가는 어디까지나 해당 증권사 의견입니다.\n"
        "전력기기 업황을 같이 봐야 할 것 같은데요.\n"
        "다들 어떻게 보시나요.</pre>\n"
        "<i>↑ 회색 박스를 탭하면 이 본문만 복사됩니다. "
        "AI 생성 표기·출처·투자책임 문구는 앱이 자동으로 붙이므로 복사되지 않습니다.</i>"
    )
