...
cases = [
    ...
    # 격식체만 나열하면 어미단조로 걸린다 (종토방 실측: '~습니다' 1.7%)
    ("어미단조", "로보티즈가 어제 20.32% 올랐습니다. 종가는 299,000원입니다. "
                "거래대금은 2,990억원이었습니다. 장 초반부터 거래가 몰렸습니다.", True),
    # 수치가 셋 이상이면 관계 서술이 있어야 통과한다 (fit 3점 최소 조건)
    ("수치나열", "로보티즈가 어제 20.32% 올랐네요. 종가는 299,000원입니다. "
                "거래대금은 2,990억원이었습니다.", True),
    ("정상", "로보티즈가 어제 20.32% 올랐네요. 종가는 299,000원입니다. "
             "거래대금 2,990억원 가운데 상당분이 장 초반에 몰렸는데요. "
             "이후에는 큰 변동 없이 마감했습니다.", False),
]
